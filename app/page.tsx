...
export default function HomePage() {
  ...
  return (
    <div style={{ backgroundColor: 'var(--color-bg)', minHeight: '100vh' }}>
      ...
      {/* 5. BOTTOM BANNER: COMERCIO ADHERITE */}
      <div style={{ padding: '0 20px 40px 20px', maxWidth: '600px', margin: '0 auto' }}>
        <a 
        ...
        >
          <span style={{ 
            ...
            ¡Sumá tu comercio a la guía y multiplicá tus ventas! 🚀<br />
            <span style={{ color: '#f1c40f' }}>Contactanos: 02942 661000</span>
          </span>
          <svg width="32" height="32" viewBox="0 0 24 24" fill="#f1c40f" style={{ flexShrink: 0 }}>
